...
import {PhpBoot} from '../../utils/havok/bootTypes';
...
const service = bootApi.phpboots;

export default class PhpbootView extends Base<Props, State> {
    state:State = {
    ...
    render() {
        ...
        return (
            <div id='content'>
                <ItemHeader title={['Phpboots', namespace, name]} ready={!!item}>
                    <>
                        <ScaleButton
                            namespace={namespace}
                            name={name}
