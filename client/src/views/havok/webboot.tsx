...
import {WebBoot} from '../../utils/havok/bootTypes';
...
const service = bootApi.webboots;

export default class WebbootView extends Base<Props, State> {
    state:State = {
    ...
    render() {
        ...
        return (
            <div id='content'>
                <ItemHeader title={['Webboots', namespace, name]} ready={!!item}>
                    <>
                        <ScaleButton
                            namespace={namespace}
                            name={name}
