...
import {PythonBoot} from '../../utils/havok/bootTypes';
...
const service = bootApi.pythonboots;

export default class PythonbootView extends Base<Props, State> {
    state:State = {
    ...
    render() {
        ...
        return (
            <div id='content'>
                <ItemHeader title={['Pythonboots', namespace, name]} ready={!!item}>
                    <>
                        <ScaleButton
                            namespace={namespace}
                            name={name}
