...
import {JavaBoot} from '../../utils/havok/bootTypes';
...
const service = bootApi.javaboots;

export default class JavabootView extends Base<Props, State> {
    state:State = {
    ...
    render() {
        ...
        return (
            <div id='content'>
                <ItemHeader title={['Javaboots', namespace, name]} ready={!!item}>
                    <>
                        <ScaleButton
                            namespace={namespace}
                            name={name}
